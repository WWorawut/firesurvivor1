...
import call1 from "../picture2/popscore/mcall1.png";
import call2 from "../picture2/popscore/mcall2.png";
...
class Mcall extends React.Component{
  state={
    popup:false,
    link:false,
...
const connectscore = state => ({
  ...
  export default connect(connectscore)(Mcall);