...
import listfire1 from "../picture2/popscore/Mlistfire31.png";
import listfire2 from "../picture2/popscore/Mlistfire32.png";
import listfire3 from "../picture2/popscore/Mlistfire33.png";
...
class Mfire3 extends React.Component{
  state={
    class:'fadeInUp',
    class2:'fadeInUp',
    controlPopup:false,
...
{this.state.controlPopup === true ?
        ...
        <Button className="buttonjang" onClick={this.openpop({link:'link',state:'popup',sound:sound3})}>นำถังขยะเปล่าครอบเพลิง</Button>
        <br/>
        <Button className="buttonjang" onClick={this.openpop({link:'link',state:'popup2',sound:sound4})}>ใช้ผ้าชุบน้ำตบปลั๊กไฟ</Button>
        <br/>
        <Button className="buttonjang" onClick={this.openpop({link:'link',state:'popup3',sound:sound5})}>ใช้น้ำราด ไปที่ปลั๊กไฟ</Button>
        </div>
        </div>
      :
      null
...
const connectscore = state => ({
  ...
  export default connect(connectscore)(Mfire3);
