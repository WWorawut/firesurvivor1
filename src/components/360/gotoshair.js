...
import bu from "../picture2/popscore/goshair.png";
...
class gotoshair2 extends React.Component {
  constructor(props) {
    super(props);
    this.state = { 
      clickedSound:true,
  ...
  Redirect=()=>{
  if(this.state.link){ return <Redirect to="/stair19"/> }
...
export default connect(connectscore)(gotoshair2);
