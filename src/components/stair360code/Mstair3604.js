...
class Mstair3604 extends React.Component {
  constructor(props) {
    super(props);
    this.state = { 
      clickedSound:true,
  ...
  Redirect=()=>{
    if(this.state.up){ return <Redirect to="/Mstair3601"/> }
    if(this.state.down){ return <Redirect to="/Mwalk360"/> }
}
...
export default connect(connectscore)(Mstair3604);
