...
class stair3606 extends React.Component {
  constructor(props) {
    super(props);
    this.state = { 
      clickedSound:true,
  ...
  Redirect=()=>{
    ...
    if(this.state.link){ return <Redirect to="/stair3607"/> }
}
  ...
  render() {
    ...
    <div>
      ...
      <div className="centerlist">
       <img className={"list animated fadeInUp"} onClick={this.openpop({link:'link',score:-5,state:'popup',sound:sound3})} src={list151}/>
       </div>
       <div className="centerlist2">
       <img className={"list animated fadeInUp"} onClick={this.openpop({link:'link',score:2,state:'popup1',sound:sound4})} src={list152}/>
       </div>
       <div className="centerlist2">
      <img className={"list animated fadeInUp"} onClick={this.openpop({link:'link',score:7,state:'popup2',sound:sound5})} src={list153}/>
       </div>
       </div>
       </div>
       }
...
export default connect(connectscore)(stair3606);
