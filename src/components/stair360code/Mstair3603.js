...
class Mstair3603 extends React.Component {
  constructor(props) {
    super(props);
    this.state = { 
      clickedSound:true,
...
{/* 
      ...
      />
       ...
       <img className={"list animated fadeInUp"} onClick={this.openpop({link:'link',state:'popup',sound:sound3})} src={listrun1}/>
       </div>
       <div className="centerlist2">
      <img className={"list animated fadeInUp"} onClick={this.openpop({link:'link',state:'popup1',sound:sound4})} src={listrun2}/>
       </div>
       <div className="centerlist2">
      <img className={"list animated fadeInUp"} onClick={this.openpop({link:'link',state:'popup2',sound:sound5})} src={listrun3}/>
       </div>
       </div>
...
export default connect(connectscore)(Mstair3603);
