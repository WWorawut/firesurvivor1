...
class stair3607 extends React.Component {
  constructor(props) {
    super(props);
    this.state = { 
      clickedSound:true,
  ...
  Redirect=()=>{
    if(this.state.up){ return <Redirect to="/stair3605"/> }
    if(this.state.down){ return <Redirect to="/stair3608"/> }
}
...
export default connect(connectscore)(stair3607);
