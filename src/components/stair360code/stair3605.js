...
class stair3605 extends React.Component {
  constructor(props) {
    super(props);
    this.state = { 
      clickedSound:true,
  ...
  Redirect=()=>{
    if(this.state.up){ return <Redirect to="/stair3604"/> }
    if(this.state.down){ return <Redirect to="/stair3606"/> }
}
...
export default connect(connectscore)(stair3605);
