...
import floor from '../picture2/stair360/floor13.png'
...
class Mstair3607 extends React.Component {
  constructor(props) {
    super(props);
    this.state = { 
      clickedSound:true,
  ...
  Redirect=()=>{
    if(this.state.up){ return <Redirect to="/Mstair3605"/> }
    if(this.state.down){ return <Redirect to="/Mstair3608"/> }
}
...
export default connect(connectscore)(Mstair3607);
