...
class stair36010 extends React.Component {
  constructor(props) {
    super(props);
    this.state = { 
      clickedSound:true,
  ...
  Redirect=()=>{
    if(this.state.up){ return <Redirect to="/stair3609"/> }
    if(this.state.down){ return <Redirect to="/stair36011"/> }
}
...
export default connect(connectscore)(stair36010);
