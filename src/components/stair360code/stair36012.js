...
class stair36012 extends React.Component {
  constructor(props) {
    super(props);
    this.state = { 
      clickedSound:true,
  ...
  Redirect=()=>{
    if(this.state.up){ return <Redirect to="/stair36010"/> }
    if(this.state.down){ return <Redirect to="/stair36013"/> }
}
...
export default connect(connectscore)(stair36012);
