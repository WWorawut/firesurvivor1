...
import floor from '../picture2/stair360/floor9.png'
...
class Mstair3609 extends React.Component {
  constructor(props) {
    super(props);
    this.state = { 
      clickedSound:true,
  ...
  Redirect=()=>{
    if(this.state.up){ return <Redirect to="/Mstair3607"/> }
    if(this.state.down){ return <Redirect to="/Mstair36010"/> }
}
...
export default connect(connectscore)(Mstair3609);
