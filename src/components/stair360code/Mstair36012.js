...
class Mstair36012 extends React.Component {
  constructor(props) {
    super(props);
    this.state = { 
      clickedSound:true,
  ...
  Redirect=()=>{
    if(this.state.up){ return <Redirect to="/Mstair36010"/> }
    if(this.state.down){ return <Redirect to="/Mstair36013"/> }
}
...
export default connect(connectscore)(Mstair36012);
