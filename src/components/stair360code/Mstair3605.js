...
import floor from '../picture2/stair360/floor16.png'
...
class Mstair3605 extends React.Component {
  constructor(props) {
    super(props);
    this.state = { 
      clickedSound:true,
  ...
  Redirect=()=>{
    if(this.state.up){ return <Redirect to="/Mstair3604"/> }
    if(this.state.down){ return <Redirect to="/Mstair3606"/> }
}
...
export default connect(connectscore)(Mstair3605);
