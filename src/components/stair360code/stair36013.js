...
import floor from '../picture2/stair360/floor2.png'
...
class stair36013 extends React.Component {
  constructor(props) {
    super(props);
    this.state = { 
      clickedSound:true,
  ...
  Redirect=()=>{
    if(this.state.up){ return <Redirect to="/stair36012"/> }
  ...
  render() {
    ...
    <div>
      ...
      />     
       ...
       <img className={"firetext1 animated " +this.state.class} src={endstairtalk}/>
       </div>
...
export default connect(connectscore)(stair36013);
