...
class stair3609 extends React.Component {
  constructor(props) {
    super(props);
    this.state = { 
      clickedSound:true,
  ...
  Redirect=()=>{
    if(this.state.up){ return <Redirect to="/stair3607"/> }
    if(this.state.down){ return <Redirect to="/stair36010"/> }
}
...
export default connect(connectscore)(stair3609);
